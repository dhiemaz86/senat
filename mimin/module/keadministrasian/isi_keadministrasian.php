<?php
	...
	$keadministrasian = new administrasi();
	$data=$keadministrasian->readALLAdministrasi();
...
<!--<a href="view_add_kirimproposal.php">Kirim Proposal</a><br> -->
 <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            File
            <small>Keadministrasian</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active">Keadministrasian</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Keadministrasian</h3>
