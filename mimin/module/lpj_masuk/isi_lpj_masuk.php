<?php
	...
	$data=$kirim_lpj->readALLKirim_lpj();
           ...
           <div class="col-xs-12">
             <div class="box">
               <div class="box-header">
                 <h3 class="box-title">LPJ Masuk</h3>
	...
	<tr>
		...
		<td><div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="ARSIP/LPJ/lpj_masuk/<?php echo $a['user'] ?>/<?php echo $a['lpj'] ?>" data-toggle="modal" data-target="#modal<?php echo $pro['sales_id'];?>">Download</a></li>
                    <li><a href="adminweb.php?module=edit_lpj">Edit</a></li>              
